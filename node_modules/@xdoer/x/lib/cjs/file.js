...
exports.isImg = exports.getFileExt = exports.convertURLToBlob = exports.convertImgUrlToBase64 = exports.convertBase64ToBlob = void 0;
 ...
 * @param ratio 压缩率
 */
const convertImgUrlToBase64 = function (imgURL) {
  let ratio = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0.1;
  return new Promise((resolve, reject) => {
    ...
    img.onload = function () {
      ...
      ctx.drawImage(img, 0, 0, img.width, img.height); // const type = img.src.substring(img.src.lastIndexOf(".") + 1).toLowerCase()
...
exports.convertImgUrlToBase64 = convertImgUrlToBase64;
...
const convertURLToBlob = (imgURL, callback) => {
...
exports.convertURLToBlob = convertURLToBlob;
