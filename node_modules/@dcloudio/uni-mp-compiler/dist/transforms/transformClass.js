...
exports.rewriteClass = exports.findStaticClassIndex = exports.isClassBinding = void 0;
...
function isClassBinding({ arg }) {
    return (arg && arg.type === 4 /* SIMPLE_EXPRESSION */ && arg.content === 'class');
}
...
function rewriteClass(index, classBindingProp, props, context) {
    if (!classBindingProp.exp) {
        return;
    }
    const expr = (0, ast_1.parseExpr)(classBindingProp.exp, context);
    if (!expr) {
        return;
    }
    let classBindingExpr = expr;
