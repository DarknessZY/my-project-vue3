        ...
        if (prop.type === 7 /* DIRECTIVE */) {
            ...
            if (isVBind || isVOn) {
                ...
                if (!(arg.type === 4 /* SIMPLE_EXPRESSION */ && arg.isStatic)) {
                    if (isVOn) {
                        context.onError((0, errors_1.createMPCompilerError)(1 /* X_V_ON_DYNAMIC_EVENT */, loc));
                    }
                    if (isVBind && (!isComponent || isPluginComponent)) {
                        context.onError((0, errors_1.createMPCompilerError)(3 /* X_V_BIND_DYNAMIC_ARGUMENT */, loc));
                    }
                    continue;
                }
            }
