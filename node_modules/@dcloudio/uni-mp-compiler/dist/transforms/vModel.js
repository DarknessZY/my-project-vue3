...
const transformModel = (dir, node, _context) => {
    ...
    if (dir.modifiers.length) {
        ...
        const modifiersKey = arg
            ...
            : `modelModifiers`;
        baseResult.props.push((0, compiler_core_1.createObjectProperty)(modifiersKey, (0, compiler_core_1.createSimpleExpression)(`{ ${modifiers} }`, false, dir.loc, 2 /* CAN_HOIST */)));
    }
...
function transformVModel(props, node, context, { isComponent, binding, event, formatEventCode, }) {
    ...
    const vOnValue = (onUpdateExpr.type === 20 /* JS_CACHE_EXPRESSION */
        ? onUpdateExpr.value
        : onUpdateExpr);
