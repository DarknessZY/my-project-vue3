...
const transformSlot = (node, context) => {
    ...
    for (let i = 0; i < children.length; i++) {
        ...
        if (onComponentSlot) {
            ...
            context.onError((0, compiler_core_1.createCompilerError)(37 /* X_V_SLOT_MIXED_SLOT_USAGE */, slotDir.loc));
            break;
        }
        if (!slotDir.arg) {
...
function transformTemplateSlotElement(slotDir, slotTemplate, slotComponent, context) {
    ...
    // empty
    if (exp.type === 4 /* SIMPLE_EXPRESSION */ && !exp.content.trim()) {
        return slotName;
    }
