                ...
                if (dir.type === 7 /* DIRECTIVE */) {
                    ...
                    if (exp) {
                        if (isBuiltIn(dir)) {
                            ...
                            (0, transformClass_1.rewriteClass)(i, dir, props, context);
                        }
                        else if ((0, transformStyle_1.isStyleBinding)(dir)) {
                            hasStyleBinding = true;
                            (0, transformStyle_1.rewriteStyle)(i, dir, props, context);
                        }
...
function isBuiltIn({ arg, exp }) {
    return ((arg === null || arg === void 0 ? void 0 : arg.type) === 4 /* SIMPLE_EXPRESSION */ &&
